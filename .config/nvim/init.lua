...
require("lazy").setup({
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			vim.keymap.set("n", "<F3>e", function()
				vim.cmd("tabnew | Ex")
				...
				builtin.find_files({
					...
					attach_mappings = function(prompt_bufnr, map)
						...
						map("i", "<CR>", function()
							...
							vim.cmd("vs " .. selection.value)
						end)
						return true
					end,
				})
			end, { desc = "[S]plit Vertically with selectable file" })
	...
	{ -- Highlight, edit, and navigate code
		...
		--    - Show your current context: https://g:ithub.com/nvim-treesitter/nvim-treesitter-context
